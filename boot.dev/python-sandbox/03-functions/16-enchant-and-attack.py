# * Enchant and Attack
# * One function: name the enchanted weapon and apply bonus damage.
# ? enchanted_damage = damage + 10
# ? new_health = target_health - enchanted_damage
# ? enchanted_weapon = "enchanted " + weapon  (e.g. sword → enchanted sword)
# ? return enchanted_weapon, new_health  (name first, then health)
