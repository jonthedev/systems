# * Curse
# * Two return values: how much damage is left after a curse.
# ? lesser:  50% of original  →  * 0.5
# ? greater: 25% of original  →  * 0.25  (stronger curse)
# ? Percent of a number: n * 0.3 is 30% of n.
# ? float() in the prints is just "show as a decimal" — types chapter later.
